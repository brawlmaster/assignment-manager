// Focus Tasks app - restored with cancel and delete fixes
...
(async function init(){ const min=new Date(nowMs()+30*60*1000); dueInput.min=toInputDateTime(min.getTime()); await registerSW(); await ensureNotificationPermission(); await loadTasks(); render(); await refreshReminders(); })();
